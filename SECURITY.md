...
If you discover a security vulnerability in this integration, please report it privately by creating a [security advisory](https://github.com/cyberjunky/ha-garmin/security/advisories) on GitHub.
...
ha-garmin stores you login tokens in your home folder (depending on how the project is used):

- Keep your `.garmin_token.json' file secure
- Do not share your home folder backups without sanitizing sensitive data
- When used via home-assistant-garmin_connect tokens will be stored in home assistant itself
...
1. **Keep home assistant updated** - Updates are released regularly
